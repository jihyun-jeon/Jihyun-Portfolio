      ...
      <div tw="max-w-3xl mx-auto">
        ...
        <div tw="my-20  sm:(px-3 text-xs)">
          <div tw="max-w-[660px] mx-auto">
            ...
            <Accordion
              CarouselTitle={
                "1. React Hook Form 라이브러리를 활용한 로그인 구현"
              }
            >
              <div>
                <div tw="mb-6">
                  로그인 폼 유효성 검사시 좀 더 직관적이고 간결한 코드를 쓸 수
                  있어서 React Hook Form <br />
                  라이브러리를 사용하였습니다.
                </div>
                ...
                <div tw="mb-6">
                  ...
                  <p tw="ml-2 mt-1">
                    <span> - </span>
                    이메일과 비밀번호 필수 입력, 입력 길이 검사, 정규식을 활용한
                    비밀번호 유효성 검사
                  </p>
                  <p tw="ml-2 mt-1">
                    <span> - </span>
            ...
            <Accordion CarouselTitle={"3. Redux Toolkit을 사용한 상태관리"}>
              <div tw="mb-6">
                사용자 리스트 데이터를 store로 관리하여 고객명 수정, 사용자
                추가, 사용자 삭제 시 자동으로 리렌더링 되도록 처리하였습니다.
              </div>
            </Accordion>
          </div>
          ...
          <div tw="max-w-[660px] mx-auto my-10">
            ...
            <p tw="py-2">
              원티드 프리온보딩 프로그램 수료 후 익명으로 진행한 동료평가
              입니다.
            </p>
            <Zoom>
              <Image
